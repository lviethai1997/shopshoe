			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
                        ...
                        <a href="#">Brands<span class="lnr lnr-arrow-right"></span></a>
                        @if(isset( $cateProduct->c_name))
                        <a href="category.html">{{ $cateProduct->c_name}}</a>
                        @endif
					</nav>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-xl-3 col-lg-4 col-md-5">
				...
				<div class="sidebar-filter mt-50">
					<div class="top-filter-head">Lọc theo giá</div>
					<div class="common-filter">
						<div class="head">Khoảng</div>
						<form action="#">
							<ul class="active-filter">
								<li class="filter-list"><input class="pixel-radio" type="radio" id="apple" name="brand"><label for="apple"><a class="{{ Request::get('price') ==1 ? 'active' : ''}}" href="{{ request()->fullUrlWithQuery(['price' => 1]) }}">Dưới $100<span>(29)</span></a></label></li>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="asus" name="brand"><label for="asus"><a class="{{ Request::get('price') ==2 ? 'active' : ''}}" href="{{ request()->fullUrlWithQuery(['price' => 2]) }}">Từ $100 - $300<span>(29)</span></a></label></li>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="gionee" name="brand"><label for="gionee"><a class="{{ Request::get('price') ==3 ? 'active' : ''}}" href="{{ request()->fullUrlWithQuery(['price' => 3]) }}">Từ $300 - $500<span>(19)</span></a></label></li>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="micromax" name="brand"><label for="micromax"><a class="{{ Request::get('price') ==4 ? 'active' : ''}}" href="{{ request()->fullUrlWithQuery(['price' => 4]) }}">Từ $500 - $900<span>(19)</span></a></label></li>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="samsung" name="brand"><label for="samsung"><a class="{{ Request::get('price') ==5 ? 'active' : ''}}" href="{{ request()->fullUrlWithQuery(['price' => 5]) }}"><span>Trên $1000</span></a></label></li>
							</ul>
						</form>
					</div>
					<div class="common-filter">
                    ...
                    <div class="filter-bar d-flex flex-wrap align-items-center">
                        <div class="sorting" >
                            <select name="orderby" class="orderby">
                                <option {{ Request::get('orderby') == "md" ? "selected='selected'" : "" }} value="md">Mặc định</option>
                                <option {{ Request::get('orderby') == "desc" ? "selected='selected'" : "" }} value="desc">Mới nhất</option>
                                <option {{ Request::get('orderby') == "asc" ? "selected='selected'" : "" }} value="asc">Hot</option>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="single-product">
                                    ...
                                    <div class="product-details">
                                        <a href=""><h6>{{ $product->pro_name}}</h6></a>
                                        <div class="price">
                                            <h6>{{ number_format($product->pro_price,0,',','.')}}đ</h6>
