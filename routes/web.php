...
Route::group(['namespace' => "Auth"],function(){
    ...
    Route::get('/lay-lai-mat-khau','ForgotPasswordController@getFormResetPassword')->name('get.forgot.password');
    Route::post('/lay-lai-mat-khau','ForgotPasswordController@sentCodeResetPassword');
...
Route::group(['prefix' => 'user','middleware' => 'CheckLoginUser'],function(){
    ...
    Route::get('/san-pham-quan-tam','UserController@getProductCare')->name('user.product.care');
});
